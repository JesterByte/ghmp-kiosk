$(document).ready(function () {
    ...
    const map = L.map("map").setView([kioskLat, kioskLng], 19); // Use kiosk location as the center
    ...
    L.marker([kioskLat, kioskLng]).addTo(map).bindPopup("Kiosk").openPopup();
    L.marker([graveLat, graveLng]).addTo(map).bindPopup("Resting Place").openPopup();
